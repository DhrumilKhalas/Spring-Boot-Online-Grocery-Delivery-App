...
import in.grocerymart.grocerymart_backend.entity.OrderEntity;
...
import in.grocerymart.grocerymart_backend.repository.OrderRepository;
...
//        newOrder.setAmount(razorpayOrder.get("amount"));
        newOrder.setAmount(((Integer) razorpayOrder.get("amount")).doubleValue());
